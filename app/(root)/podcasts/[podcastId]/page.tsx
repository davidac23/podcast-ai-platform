...
import { PodcastDetailPlayerProps, PodcastProps } from '@/types'
...
const PodcastDetails = ({ params }: { params: { podcastId: Id<'podcasts'> } }) => {
  ...
  console.log("user", user, "podcast", podcast)
      ...
      <section className='mt-8 flex flex-col gap-5'>
        ...
        {similarPodcasts && similarPodcasts.length > 0 ? (
          <div className='podcast_grid'>
            {similarPodcasts?.map(({ _id, podcastDescription, imageUrl, podcastTitle }) => (
              <PodcastCard
                key={_id}
                imgUrl={imageUrl!}
                title={podcastTitle}
